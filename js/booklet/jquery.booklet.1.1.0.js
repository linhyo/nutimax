        ...
        gotoPage: function (num) {
          ...
          if (num > opts.curr && num < opts.pTotal && num >= 0 && !busy) {
            ...
            p3.stop().animate({
              left: opts.pWidthH,
              width: opts.pWidthH,
              paddingLeft: opts.shadowBtmWidth
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function initPages() {
      ...
      src.children().each(function (i) {
        ...
        if (opts.closed && opts.covers && (i == 1 || i == src.children().length - 2)) {
    ...
    function resetPages() {
      ...
      wraps.attr('style', '');
      wraps.css({
        'width': opts.pWidth - (opts.pagePadding * 2),
        'height': opts.pHeight - (opts.pagePadding * 2),
        'padding': opts.pagePadding
      });
